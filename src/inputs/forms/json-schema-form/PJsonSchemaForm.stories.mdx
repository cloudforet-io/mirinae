...
import PPanelTop from "@/data-display/titles/panel-top/PPanelTop";
import {
...
|reference|custom|[Filterable Dropdown](?path=/docs/inputs-dropdown-filterable-dropdown--basic)|It represents name of reference type. supports `string` type only|
...
<Canvas>
    <Story name="Validation Mode" >
        {{
            components: { PJsonSchemaForm, PTextEditor, PSelectDropdown, PPanelTop },
            i18n,
            template: `
<div class="grid grid-cols-12">
    <p-json-schema-form
