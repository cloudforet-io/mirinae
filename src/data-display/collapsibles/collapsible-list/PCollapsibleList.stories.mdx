...
import { getCollapsibleListArgTypes } from '@/data-display/collapsibles/collapsible-list/story-helper';


<Meta title='Data Display/Collapsibles/Collapsible List' parameters={{
    design: {
        type: 'figma',
